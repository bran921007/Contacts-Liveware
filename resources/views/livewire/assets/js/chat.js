...
$(document).ready(function() {
	...
	$( ".side-widget-content" ).delegate( ".user-details-wrapper", "click", function(){
	...
	$( ".side-widget-content" ).delegate( ".lobby", "click", function(){
		user_id = $(this).attr('id');
		loadHistory(user_id);
	...
	$(".chat-messages").delegate(".bubble", "click", function(){
