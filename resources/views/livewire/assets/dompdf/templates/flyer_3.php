...
#ground{
  background-image: url('http://localhost/linc/public/assets/dompdf/templates/template_three.jpg');
...
#photoz{
  ...
  <body>
    <div class="flip" id="ground">
            <div class="face front"  style="height:640px; width:330px;"> 
                    <?php 
                    $id = $_GET['id'];
                  ...
                  ?>
                    ...
                    <div style="margin-top:222px; margin-left:120px;">
                      <h5 style="color:black;">  <?php echo $r['detail'];  ?> </h5>   
                    </div>
                    <?php
                    if($r['photo'] != ""){
                    ?>
                    <img src="http://localhost/linc/public/assets/img/logoo.png" style="height:70px; width:90px; margin-left:235px; margin-top:100px; position: relative; z-index:34;">
